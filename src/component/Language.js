    ...
    render() {
        return (
            <div className="Language">
                <button type="button" className="ripple btn" onClick={this.changeLanguage.bind(this)}>
                  ...
                  <p onClick={this.setLanguage.bind(this, 'en')}>{__('English')}</p>
                  <p onClick={this.setLanguage.bind(this, 'sr')}>{__('Serbian')}</p>
                  </div>
                  <span className="btn__label"> {__('Change Language')}</span>
