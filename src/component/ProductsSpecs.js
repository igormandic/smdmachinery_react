                                                    ...
                                                    <a href="/machines/265">
                                                        <article className="media media--type-image media--view-mode-menu-image">
                                                            <div className="field field--name-field-image-file field--type-image field--label-hidden field__item">    
                                                                <img src="/WILLE/265/265_pose_thumb.png" alt="Wille 265" typeof="Image"></img>
                                                            </div>
                                                        </article>
                                                        <span>265</span></a><a></a></th>
                                                            <th className="views-field views-field-field-machine-image">
                                                                <a href="/machines/375">
                                                                    <article className="media media--type-image media--view-mode-menu-image">
                                                                        <div className="field field--name-field-image-file field--type-image field--label-hidden field__item">    
                                                        ...
                                                        <span>465</span></a><a></a></th>
                                                            <th className="views-field views-field-field-machine-image">
                                                                <a href="/machines/665">
                                                                    <article className="media media--type-image media--view-mode-menu-image">
                                                                        <div className="field field--name-field-image-file field--type-image field--label-hidden field__item">    
                                                                            <img src="/WILLE/665/665iv_pose_thumb_v2.png" alt="Wille 665 stage 4 thumbnail image" typeof="Image"></img>
                                                                        </div>
                                                                    </article>
                                                        <span>665</span></a><a></a></th>
                                                            <th className="views-field views-field-field-machine-image">
                                                                <a href="/machines/865">
                                                                    <article className="media media--type-image media--view-mode-menu-image">
                                                                        <div className="field field--name-field-image-file field--type-image field--label-hidden field__item">    
