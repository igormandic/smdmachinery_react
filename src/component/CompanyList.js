            ...
            <div className="wrap">
                ...
                <div className="homepage">
                    <ListGroup  className= "companyList" >
                        ...
                        <div className = "cards">
                            <div className = "card1"> <a href="ContactPage.js"><img src = "img/Wille/images.jpg" alt=""></img></a> </div>
                            <div className = "card2"> <a href="App.js"><img src = "img/Wille/images.jpg" alt=""></img></a> </div>
                        </div>
                    </ListGroup>
                </div>
            </div>
